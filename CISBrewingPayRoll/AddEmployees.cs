...
using CISBrewingPayroll.Includes;
    ...
    public partial class frm_Employees : Form
    {
        ...
        private void btnempsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                config.Execute_CUD(sql, "Missing required employee information fields.", "Data has been saved in the database.");
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Employee has been deleted from the database", "Delete",MessageBoxButtons.OK, MessageBoxIcon.Information);
            btnempnew_Click(sender, e);
        }
